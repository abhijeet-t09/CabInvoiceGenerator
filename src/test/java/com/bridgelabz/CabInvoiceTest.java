...
public class CabInvoiceTest {
    ...
    void givenMultipleRidesShouldReturnAggregateTotalFare(){
        Ride ride1 = new Ride(Ride.Category.NORMAL_RIDE,10,5);
        Ride ride2 = new Ride(Ride.Category.NORMAL_RIDE,20,10);
        ...
        Assertions.assertEquals(320.0,totalFare);
    }
    ...
    void givenMultipleRideShouldReturnInvoice(){
        ...
        Invoice expectedInvoice = new Invoice(3,320.0,(320.0/3));
    ...
    void givenUserIdShouldReturnTheInvoice(){
        ...
        Ride ride4 = new Ride(Ride.Category.PREMIUM_RIDE,24,12);
        Ride ride5 = new Ride(Ride.Category.PREMIUM_RIDE,15,5);
        ...
        Invoice expectedInvoice = new Invoice(3,639.0,(639.0/3));
        Assertions.assertEquals(expectedInvoice,actualInvoice);
    }
